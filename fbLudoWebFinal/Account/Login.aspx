<%@ Page Title="Anmelden" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="fbLudoWebFinal.Account.Login" Async="true" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="ForgotPasswordHyperLink" ViewStateMode="Disabled">Passwort vergessen?</asp:HyperLink>
                </p>
            </section>
        </div>
